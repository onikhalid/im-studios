    ...
    return (
        ...
        <div className='h-screen snap-y snap-always overflow-y-scroll bg-black'>
            <section className='grid grid-cols-1 md:grid-cols-2 lg:min-h-[90vh] pt-20 md:pt-0'>
                ...
                <div className="pt-12 leading-tight lg:max-h-full overflow-hidden lg:sticky top-0 p-6 m-auto">
                ...
                <div className='text-[#FFFFFFE8] xl:text-xl font-light flex flex-col justify-center max-w-xl mx-auto'>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 lg:min-h-[90vh] pt-20 md:pt-0'>
                    ...
                    <div className='grid lg:grid-cols-2 gap-10'>
                        {
                            appInfo?.team_members.map((member, index) => (
                                <article key={index} className='text-black'>
                                    ...
                                    <div className='border-[0.5px] grid grid-cols-2 gap-7 leading-tight rounded-[1.25rem] px-4 py-3.5 -translate-y-20 mx-2 backdrop-blur-lg bg-gradient-to-r from-[#FFFFFF33] to-[#FFFFFF20]'>
                                        <div>
                                            <h4 className='text-[10px] font-semibold'>{member.name}</h4>
                                            <h4 className='text-[6px] font-semibold mt-2'>{member.role}</h4>
                                        </div>
                                        <div className='flex gap-3 mt-4'>
                                            <Link href={member.ig_link || '#'}> <Instagram className=' size-2.5' /> </Link>
                                            <Link href={member.fb_link || '#'}> <Facebook className=' size-2.5' /> </Link>
                                            <Link href={member.x_link || '#'}> <Twitter className=' size-2.5' /> </Link>
                                            <Link href={member.x_link || '#'}> <Twitter className=' size-2.5' /> </Link>
                                        </div>
                                    </div>
                                </article>
                ...
                <div className="pt-12 leading-tight lg:max-h-full overflow-hidden lg:sticky top-0 p-6 m-auto">
                    <div className='flex'>
                        ...
                        <p className='text-xs font-sans font-light text-white mt-24'>At IM STUDIOZ, our team combines creativity and technical expertise to deliver exceptional sound and overall level of professionalism for your music process..</p>
                    </div>
